...
class TestPatchOrphanToolCalls:
    """Test suite for patch_orphan_tool_calls function."""

    def test_empty_messages_list(self):
        assert patch_orphan_tool_calls([]) == []
    ...
    def test_complete_tool_call_only(self):
        messages = [
            AIMessage(
                content="",
    ...
    def test_multiple_orphan_tool_calls(self):
        messages = [
            AIMessage(
                content="",
                tool_calls=[
